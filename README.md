...
Once the dependencies are imported we can read and load the labelled dataset provided under folder ‘notebook’ (week1_labelled_tweets2.csv and week2_labelled_tweets2.csv). Loading the dataset the notebook can be run in a step wise manner. Dist plot showing length of data used for model generation.
